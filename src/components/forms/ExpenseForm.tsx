  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <Select onValueChange={(val) => setValue('frequency', val as ExpenseFrequency)} defaultValue="monthly">
          <SelectTrigger>
      ...
      <div>
        ...
        <Select onValueChange={(val) => setValue('category', val as ExpenseCategory)} defaultValue="other">
          <SelectTrigger>
      ...
      <div>
        ...
        <Select onValueChange={(val) => setValue('bankId', val)} defaultValue="">
          <SelectTrigger>
