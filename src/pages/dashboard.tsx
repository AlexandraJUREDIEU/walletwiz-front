...
import { ExpensesSummary } from '@/components/widgets/ExpensesSummary';
    ...
    <section className="space-y-6">
      ...
      <div className="rounded-xl border p-6 shadow-sm bg-white">
        ...
        <ul className="grid grid-cols-2 gap-2 text-sm">
          <li>
            Vital : <strong>653.20€</strong>
          </li>
          <li>
            Voiture : <strong>210.00€</strong>
          </li>
          <li>
            Loisirs : <strong>310.54€</strong>
          </li>
          <li>
            Épargne : <strong>216.54€</strong>
          </li>
        </ul>
      </div>
      ...
      <div className="rounded-xl border p-6 shadow-sm bg-white flex gap-4">
        ...
        <button className="bg-muted px-4 py-2 rounded-lg text-sm">Ajouter une charge</button>
      </div>
      {/* Widgets */}
